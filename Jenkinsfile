    ...
    stages {
        ...
        stage('stage two') {
            steps {
                ...
                sh "sudo ssh -i /home/matef/Downloads/dondon-monitor.pem ec2-user@3.21.162.162' scp -r /var/lib/jenkins/workspace/test1/* ec2-user@3.21.162.162:/home/ec2-user/pro'"
