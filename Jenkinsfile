        ...
        stage('Build and push images ') {
         ...
         stage('copy files to AWS server') {
            ...
            steps {
                ...
                sh "sudo rsync -rv --update -e 'ssh -i /home/matef/Downloads/dondon-monitor.pem' -r -p /var/lib/jenkins/workspace/test1/web/static/ ec2-user@3.22.235.5:/home/ec2-user/pro/web/static/" 
            }
        }
